...
//aws cert 01
document.addEventListener('DOMContentLoaded', () => {
    const viewBtn = document.getElementById('aws-pdf-view-btn');
    const downloadLink = document.getElementById('aws-pdf-download');
    const modal = document.getElementById('pdf-modal');
    const modalClose = document.getElementById('pdf-modal-close');
    const pdfViewer = document.getElementById('pdf-viewer');

    const staticPdfPath = 'assets/aws_cert_01.pdf';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const downloadLink = document.getElementById('finals-pdf-download');
    const modal = document.getElementById('pdf-modal');
    const modalClose = document.getElementById('pdf-modal-close');
    const pdfViewer = document.getElementById('pdf-viewer');

    const staticPdfPath = 'assets/PowerBI_Finals.pdf';
...
document.addEventListener('DOMContentLoaded', () => {
    const viewBtn = document.getElementById('e-pdf-view-btn');
    const downloadLink = document.getElementById('e-pdf-download');
    const modal = document.getElementById('pdf-modal');
    const modalClose = document.getElementById('pdf-modal-close');
    const pdfViewer = document.getElementById('pdf-viewer');

    const staticPdfPath = 'assets/ees_cc.pdf';
